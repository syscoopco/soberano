...
public class LogicalQueriesForSoberanoMetamodel extends LogicalQueriesBatch {
	...
	public LogicalQueriesForSoberanoMetamodel() {
		super.setBatch(new String[] {
				...
				+ "	lifecycleid integer,\n"
				+ "	authority integer,\n"
				+ "	decisionnamefilter character varying,\n"
				+ "	loginname character varying)\n"
				+ "    RETURNS TABLE(\"InstanceId\" integer, \"DecisionId\" integer, \"DecisionName\" character varying, \"CurrentStageName\" character varying, \"DestinationStageName\" character varying, \"IsContextual\" boolean, \"TransitionQuery\" text) \n"
				+ "    LANGUAGE 'plpgsql'\n"
				+ "    COST 100\n"
				...
				+ "							AND decision.\"This_causes_advance_to_StageFilter_with_StageFilterHasStageFilt\" = destinationStageFilter.\"StageFilterHasStageFilterId\"\n"
				+ "							AND decision.\"This_causes_advance_from_StageFilter_with_StageFilterHasStageFi\" = currentStageFilter.\"StageFilterHasStageFilterId\"\n"
				+ "		 					AND decision.\"This_has_Name\" LIKE decisionNameFilter \n"
				+ "					INNER JOIN \"metamodel\".\"ResponsibilityFilter\" responsibilityFilter\n"
				+ "						ON responsibilityFilter.\"This_belongs_to_LifeCycle_with_LifeCycleHasLifeCycleId\" = lifeCycle.\"LifeCycleHasLifeCycleId\"\n"
				+ "							AND responsibilityFilter.\"This_filters_by_Decision_with_DecisionHasDecisionId\" = decision.\"DecisionHasDecisionId\"\n"
				+ "					INNER JOIN \"metamodel\".\"User\" users\n"
				...
				+ "				  			'tt_CREATED_tt' decision, \n"
				+ "				  			\"This_has_LoginName\", \n"
				+ "				  			\"EntityTypeInstanceHasEntityTypeInstanceId\" instanceId\n"
				+ "						FROM metamodel.\"EntityTypeInstance\" eti\n"
				+ "							INNER JOIN metamodel.\"User\" u\n"
				+ "								ON eti.\"This_is_created_by_User_with_UserHasUserId\" = u.\"UserHasUserId\"\n"
				+ "						WHERE \"EntityTypeInstanceHasEntityTypeInstanceId\" = entityTypeInstanceId\n"
				+ "					UNION\n"
				+ "				SELECT \"This_is_on_Timestamp\", \n"
				+ "				  		--'tt_' || d.\"This_has_Name\" || '_tt' decision, \n"
				+ "				  		\"This_has_an_Argument\" decision,\n"
				+ "				  		\"This_has_LoginName\", \n"
				+ "				  		\"This_is_on_EntityTypeInstance_with_EntityTypeInstanceHasEntityT\" instanceId\n"
				+ "					FROM metamodel.\"Vote\" v\n"
				+ "						INNER JOIN metamodel.\"Decision\" d\n"
				+ "							ON v.\"This_favors_Decision_with_DecisionHasDecisionId\" = d.\"DecisionHasDecisionId\"\n"
				+ "						INNER JOIN metamodel.\"User\" u\n"
				+ "							ON v.\"This_is_by_User_with_UserHasUserId\" = u.\"UserHasUserId\"\n"
				+ "					WHERE v.\"This_is_on_EntityTypeInstance_with_EntityTypeInstanceHasEntityT\" = entityTypeInstanceId) sq\n"
				+ "	GROUP BY instanceId INTO history;\n"
				+ "		RETURN history;\n"
				+ "	END;\n"
				+ "$BODY$;",
				...
				+ "			WHERE \"DecisionHasDecisionId\" = NEW.\"This_favors_Decision_with_DecisionHasDecisionId\"\n"
				...
				+ "						NEW.\"This_favors_Decision_with_DecisionHasDecisionId\" = decisionvotada.\"DecisionHasDecisionId\"\n"
				...
				+ "								SELECT \"This_favors_Decision_with_DecisionHasDecisionId\" \n"
				+ "									FROM \"metamodel\".\"Vote\"\n"
				...
				+ "										AND \"Vote\".\"This_favors_Decision_with_DecisionHasDecisionId\" = decisionessincronizadas.\"DecisionHasDecisionId\") LIMIT 1)) THEN\n"
				+ "\n"
				+ "			--make the decision\n"
				+ "			PERFORM \"metamodel\".\"fn_Decision_make\"(NEW.\"This_is_on_EntityTypeInstance_with_EntityTypeInstanceHasEntityT\", NEW.\"This_favors_Decision_with_DecisionHasDecisionId\");\n"
				+ "		END IF;\n"
				+ "\n"
