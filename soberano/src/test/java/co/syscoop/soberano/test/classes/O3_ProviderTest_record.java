...
class O3_ProviderTest_record extends ProductCategoryActionTest {
	...
	final void testCase0() {
		...
		DesktopAgent desktop = Zats.newClient().connect("/new_provider.zul");
		providerForm = new ProviderForm(desktop,
		...
		try {
			...
			providerForm.testEachConstrainedObjectIsDeclared();
			providerForm.testEachDeclaredConstrainedObjectIsActuallyConstrained();
		}
	...
	final void testCase1() {
		...
		providerForm = new ProviderForm(desktop,
									(desktop.query("textbox").query("#txtName")).as(Textbox.class));
		try {
			providerForm.setComponentValue(providerForm.getTxtName(), "");		
			...
			providerForm.testWrongValueException(ex);
		}
	}	
	...
	final void testCase2() {
		...
		providerForm = new ProviderForm(desktop,
									(desktop.query("textbox").query("#txtName")).as(Textbox.class));
		try {
			providerForm.setComponentValue(providerForm.getTxtName(), "prov1");
			clickOnRecordButton(desktop);
		}
		catch(AssertionFailedError ex) {
			fail(ex.getMessage());
	...
	final void testCase5() {
		...
		providerForm = new ProviderForm(desktop,
									(desktop.query("textbox").query("#txtName")).as(Textbox.class));
		try {
			providerForm.setComponentValue(providerForm.getTxtName(), "prov3");
			clickOnRecordButton(desktop);
		}
		catch(AssertionFailedError ex) {
			fail(ex.getMessage());
	...
	final void testCase6() {
		...
		providerForm = new ProviderForm(desktop,
									(desktop.query("textbox").query("#txtName")).as(Textbox.class));
		try {
			providerForm.setComponentValue(providerForm.getTxtName(), "prov4");	
			clickOnRecordButton(desktop);
	...
	final void testCase8() {
		...
		providerForm = new ProviderForm(desktop,
									(desktop.query("textbox").query("#txtName")).as(Textbox.class));
		try {
			providerForm.setComponentValue(providerForm.getTxtName(), "prov5");
			clickOnRecordButton(desktop);
		}
		catch(AssertionFailedError ex) {
			fail(ex.getMessage());
	...
	final void testCase9() {
		...
		providerForm = new ProviderForm(desktop,
									(desktop.query("textbox").query("#txtName")).as(Textbox.class));
		try {
			providerForm.setComponentValue(providerForm.getTxtName(), "prov6");
			clickOnRecordButton(desktop);
		}
		catch(AssertionFailedError ex) {
			fail(ex.getMessage());
	...
	final void testCase10() {
		...
		providerForm = new ProviderForm(desktop,
									(desktop.query("textbox").query("#txtName")).as(Textbox.class));
		try {
			providerForm.setComponentValue(providerForm.getTxtName(), "prov7");	
			clickOnRecordButton(desktop);
	...
	final void testCase14() {
		...
		providerForm = new ProviderForm(desktop,
									(desktop.query("textbox").query("#txtName")).as(Textbox.class));
		try {
			providerForm.setComponentValue(providerForm.getTxtName(), "prov8");
			clickOnRecordButton(desktop);
		}
		catch(AssertionFailedError ex) {
			fail(ex.getMessage());
	...
	final void testCase15() {
		...
		providerForm = new ProviderForm(desktop,
									(desktop.query("textbox").query("#txtName")).as(Textbox.class));
		try {
			providerForm.setComponentValue(providerForm.getTxtName(), "prov9");	
			clickOnRecordButton(desktop);
