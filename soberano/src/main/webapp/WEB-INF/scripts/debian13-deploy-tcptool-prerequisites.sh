...
# for Ubuntu 24.04 apt install -y software-properties-common apt-transport-https
...
# Ubuntu 24.04 apt install -y openjdk-17-jdk
...
# Ubuntu 24.04 JAVA_HOME="/usr/lib/jvm/java-17-openjdk-amd64"
