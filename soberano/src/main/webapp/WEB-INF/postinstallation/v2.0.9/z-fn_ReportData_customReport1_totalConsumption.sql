CREATE OR REPLACE FUNCTION soberano."z-fn_ReportData_customReport1_totalConsumption"(
	lang character,
	fromd date,
	untild date,
	ccname character varying,
	loginname character varying)
    RETURNS TABLE(stockchangedate date, "iCode" character varying, "iCostCenterName" character varying, "iName" text, "iUnit" character varying, "iQty" numeric, "iAmount" numeric, days integer) 
    LANGUAGE 'plpgsql'
    COST 100
