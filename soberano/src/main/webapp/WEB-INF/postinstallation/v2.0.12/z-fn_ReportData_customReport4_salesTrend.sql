CREATE OR REPLACE FUNCTION soberano."z-fn_ReportData_customReport4_salesTrend"(
	lang character,
	fromd date,
	untild date,
	ccname character varying,
	loginname character varying)
    RETURNS TABLE("iName" character varying, "iQty" numeric, "iPrice" numeric) 
    LANGUAGE 'plpgsql'
    COST 100
