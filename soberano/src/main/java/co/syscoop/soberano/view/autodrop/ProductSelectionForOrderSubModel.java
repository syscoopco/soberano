...
public class ProductSelectionForOrderSubModel extends AbstractListModel<Object> implements ListSubModel<Object> { 
    ...
    public ListModel<Object> getSubModel(Object value, int nRows) {
        ...
        if (typed.isEmpty()) {
            ...
            try {
                ...
                currentResults = new Product().getAllWithUnitForOrder(typed, 15 /*nRows*/);
