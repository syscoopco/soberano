...
import co.syscoop.soberano.view.autodrop.ProductSelectionForOrderSubModel;

public class ProductSelectionForOrderViewModel extends IntellisenseViewModel {	
...
//		return ListModels.toListSubModel(new ListModelList(_model), new AutocompletionComparator(), 15);
		...
		return new ProductSelectionForOrderSubModel();
	}
}
