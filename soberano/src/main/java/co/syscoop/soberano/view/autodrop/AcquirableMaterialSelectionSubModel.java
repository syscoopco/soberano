...
public class AcquirableMaterialSelectionSubModel extends AbstractListModel<Object> implements ListSubModel<Object> { 
    ...
    public ListModel<Object> getSubModel(Object value, int nRows) {
        ...
        if (typed.isEmpty()) {
            ...
            try {
                ...
                currentResults = new AcquirableMaterial().getAll(typed, 15 /*nRows*/);
