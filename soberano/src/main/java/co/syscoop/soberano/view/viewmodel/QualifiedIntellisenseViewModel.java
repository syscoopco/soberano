...
public class QualifiedIntellisenseViewModel implements IViewModel {
	...
	protected class AutocompletionComparator implements Comparator {
		...
		public int compare(Object arg0, Object arg1) {
			...
			return ComparatorForAutocompletion.compare(((String) arg0).toLowerCase(), ((DomainObject) arg1).getQualifiedName().toLowerCase());
		}
	}
