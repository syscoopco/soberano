...
public class WithdrawButtonComposer extends CashRegisterTrackedObjectRecordButtonComposer {
	
	@Wire
	private Button btnWithdraw;
	
	public WithdrawButtonComposer() {
	...
	public void doAfterCompose(Component comp) throws Exception {
          ...
          boxDetails = (Box) btnWithdraw.query("#wndContentPanel").query("#boxDetails");
    }
